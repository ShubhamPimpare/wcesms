<?php include '../assets/constant/config.php';
   try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        $stmt = $conn->prepare("SELECT * from csa WHERE id='".$_GET['id']."'");
       $stmt->execute();
         ...
         <div class="main-content">
            <div class="container-fluid">
               <div class="page-header">
                  <h1 class="header-title">Update Co-Staff Advisor Details</h1>
                  <br><br>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select class=" xyz form-control form-control-lg "name="dname" class="xyz">
                                       <option>----Select Co-Staff Advisor Department----</option>
                                       <?php
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email"  value="<?php echo $res1['email']; ?>" required>
                                 </div>
                              </div>
