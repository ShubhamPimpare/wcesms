...
<div class="page-container">
   <div class="main-content">
      <div class="container-fluid">
         <h1 class="header-title">Manage Staff Advisor</h1>
         <br>
         <div class="card">
            <div class="card-body">
               <a href="staffadvisor.php"><button class="btn btn-info m-b-0 m-r-5">ADD STAFF ADVISOR</button></a>
               <br><br><br>
                           ...
                           <table id="example1" class="table table-border">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td >
                                       <a href="facedit.php?id=<?php echo $res['id'] ?>"class="text-gray m-r-25"><i style="color:blue;"  data-toggle="tooltip" title="Edit" class="ti-pencil"></i></a>
                                          ...
                                          <div class="modal-dialog"  role="dialog">
                                             <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                   ...
                                                   <a href="app/faccrud.php?id=<?php echo $res['id'];?>" class="btn btn-primary">Yes, I confirm</a>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
   ...
   <div class="popup__content">
      ...
      <p>
         <?php echo "<script>setTimeout(\"location.href = 'factable.php';\",100);</script>"; ?>
      </p>
   </div>
</div>
