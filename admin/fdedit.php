<?php include '../assets/constant/config.php';
   try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        $stmt = $conn->prepare("SELECT * from physicaldirector WHERE id='".$_GET['id']."'");
       $stmt->execute();
         ...
         <div class="main-content">
            <div class="container-fluid">
               <div class="page-header">
                  <h1 class="header-title">Update Physical Director Details</h1>
                  <br><br>
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Set Starting Time</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Set Ending Time</label>

                                        <input type="text" class="form-control" name="stime"  value="<?php echo $res1['etime']; ?>">
                                    </div>
                                </div>
