      ...
      <div class="page-container">
         <div class="main-content">
            <div class="container-fluid">
               <div class="card">
                  <div class="card-body">
                     <h1 class="header-title">Add Gymkhana Coordinator Details</h1>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">Gymkhana Coordinators Name </label>
                                          <input type="text" class="form-control" pattern="^[a-zA-Z ]+$" name="name" placeholder="Enter Gymkhana Coordinators Name" required>
                                       </div>
                                    </div>

                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">Select Gymkhana Coordinators Department</label>
