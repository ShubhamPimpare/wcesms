<?php include '../assets/constant/config.php';
   try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        $stmt = $conn->prepare("SELECT * from gc WHERE id='".$_GET['id']."'");
       $stmt->execute();
         ...
         <div class="main-content">
            <div class="container-fluid">
               <div class="page-header">
                  <h1 class="header-title">Update Gymkhana Coordinator Details</h1>
                  <br><br>
                  <form method="POST" action="app/gccrud.php">
                     <div class="card">
                        <div class="card-body">
                           <div class="row">
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label"> Gymkhana Coordinator Name</label>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label">Select Gymkhana Coordinator Department</label>
                                    <select class=" xyz form-control form-control-lg "name="dname" class="xyz">
                                       <option>----Select Gymkhana Coordinator Department----</option>
                                       <?php
