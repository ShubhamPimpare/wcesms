                            ...
                            <div class="card-body">
                                <div class="p-h-70 p-v-80">
                                    ...
                                    <form action="app/logincrud.php" method="POST" >
                                        ...
                                        <br>
                                        <button name="submit"class="btn btn-success btn-lg">Admin Login</button>
                                     ...
                                     <a href="../viewer/loginpage.php"><button class="btn btn-primary btn-lg text-blue">Click here for Viewer Login</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
