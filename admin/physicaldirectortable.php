...
<div class="page-container">
   <div class="main-content">
      <div class="container-fluid">
         <h1 class="header-title">Manage Physical Directors</h1>
         <br>
         <div class="card">
            <div class="card-body">
               <a href="physicaldirector.php"><button class="btn btn-info m-b-0 m-r-5">ADD Physical Director</button></a>
               <br><br><br>
                           ...
                           <table id="example1" class="table table-border">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td >
                                       <a href="fdedit.php?id=<?php echo $res['id'] ?>"class="text-gray m-r-25"><i style="color:blue;"  data-toggle="tooltip" title="Edit" class="ti-pencil"></i></a>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
   ...
   <div class="popup__content">
      ...
      <p>
         <?php echo "<script>setTimeout(\"location.href = 'physicaldirectortable.php';\",200);</script>"; ?>
      </p>
   </div>
</div>
