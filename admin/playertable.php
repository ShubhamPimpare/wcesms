...
<div class="page-container">
   <div class="main-content">
      <div class="container-fluid">
         <h1 class="header-title">Manage Players</h1>
         <br>
         <div class="card">
            <div class="card-body">
               <a href="player.php"><button class="btn btn-info m-b-0 m-r-5">ADD PLAYER</button></a><br><br><br>
                           ...
                           <table id="example1" class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="playeredit.php?id=<?php echo $res['id'] ?>"class="text-gray mr-2"><i style="color:blue;" data-toggle="tooltip" title="Edit" class="ti-pencil"></i></a>
                                          ...
                                          <div class="modal-dialog"  role="dialog">
                                             <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                   ...
                                                   <a href="app/playercrud.php?id=<?php echo $res['id'];?>" class="btn btn-primary">Yes, I confirm</a>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
   ...
   <div class="popup__content">
      ...
      <p>
         <?php echo "<script>setTimeout(\"location.href = 'playertable.php';\",200);</script>"; ?>
      </p>
   </div>
</div>
