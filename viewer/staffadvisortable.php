<?php include '../assets/constant/config.php';
   ...
   try {
        ...
        $stmt = $conn->prepare("SELECT * from staffadvisor WHERE delete_status='0'");
    //echo  "SELECT * from staffadvisor";exit;
...
<div class="page-container">
   <div class="main-content">
      <div class="container-fluid">
         <h1 class="header-title">List Of Staff Advisors</h1>
         <br>
         <div class="card">
            <div class="card-body">
...
<div class="popup popup--icon -success js_success-popup popup--visible">
   ...
   <div class="popup__content">
      ...
      <p>
         <?php echo "<script>setTimeout(\"location.href = 'factable.php';\",4000);</script>"; ?>
      </p>
   </div>
</div>
